...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ex21" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#cbed8279#;
   pragma Export (C, u00001, "ex21B");
   ...
   u00159 : constant Version_32 := 16#3190cd4a#;
   pragma Export (C, u00159, "set_qB");
   u00160 : constant Version_32 := 16#740483a4#;
   pragma Export (C, u00160, "set_qS");
